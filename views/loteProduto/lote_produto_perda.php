...
<?php if (isset($msg_erro) && !empty($msg_erro)): ?>
    <script>swal("Ocorreu um erro salvar a perda do lote.", "", "error");</script>
<?php endif; ?>

<?php if (isset($msg_sucesso) && !empty($msg_sucesso)): ?>
    <script>swal("Sucesso ao salvar a perda do lote.", "", "success");</script>
<?php endif; ?>
...
<form id="form" method="POST">
    ...
    <input type="hidden" name="preco" id="preco"
           value="<?php echo number_format($lote_produto_editar_list['preco_compra'], 2, ',', '.'); ?>"/>
    ...
    <div class="form-group col-sm-2">
        ...
        <input type="text" id="data_perda" class="form-control" disabled="true" name="data_perda"
...
<script type="text/javascript" src="<?php echo BASE_URL; ?>assets/js/loteProduto/script_lote_produto_perda.js"></script>
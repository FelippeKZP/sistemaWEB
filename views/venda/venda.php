...
<a class="btn btn-info" href="<?php echo BASE_URL; ?>venda/venda_add"><span class="glyphicon glyphicon-plus"
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger"
                       ...
                       href="<?php echo BASE_URL; ?>venda/venda_cancelar/<?php echo $v['id']; ?>"><span
...
<ul class="pagination">
    ...
    <?php endif; ?>
    <?php if ($paginaAtual != 1): ?>
        <li><a href="<?php echo BASE_URL; ?>venda?p=<?php echo $paginaAtual - 1 ?>"><span
    ...
    <?php if ($paginaAtual < $paginas): ?>
        <li><a href="<?php echo BASE_URL; ?>venda?p=<?php echo $paginaAtual + 1 ?>"><span style="height: 20px;"

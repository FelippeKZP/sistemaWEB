    ...
    <div class="form-group col-sm-5">
        ...
        <div class="form-group col-sm-3">
            ...
            <select id="status" class="form-control" name="status" >
                <option value="1" <?php echo($usuario_editar_list['status'] == 1) ? 'selected = "selected"' : ''; ?>>Ativo</option>
                <option value="0" <?php echo($usuario_editar_list['status'] == 0) ? 'selected = "selected"' : ''; ?>>Inativo</option>
            </select>
        </div>
            ...
            <div class="panel-body">
                <?php foreach ($usuario_editar_list['fotos'] as $fotos): ?>
                    <div class="foto_item">
                        ...
                        href="<?php echo BASE_URL; ?>usuario/excluir_imagem/<?php echo $fotos['id']; ?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>

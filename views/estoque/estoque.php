...
<div class="col-sm-2" style="float: right;">
	...
	<input type="text" class="form-control" id="quantidade_estoque" disabled="true" value="<?php echo $quantidade_estoque; ?>" placeholder="0" />
</div>

<div class="col-sm-2" style="float: right;">
	<label>Valor  total em estoque:</label>
	<input type="text" class="form-control" id="custo_estoque" disabled="true" value="R$ <?php echo number_format($valor_estoque,2,',','.'); ?>" placeholder="0,00" />
</div>
...
<ul class="pagination">
	...
	<?php endif; ?>
	<?php if($paginaAtual != 1): ?>
		<li><a href="<?php echo BASE_URL; ?>estoque?p=<?php echo $paginaAtual - 1; ?>"><span  class="glyphicon glyphicon-backward" aria-hidden="true" style="height: 20px;"></span></a></li>
	<?php endif; ?>
	<?php for($q =1; $q <= $paginas; $q++): ?>
		...
		<?php if($paginas > $paginaAtual): ?>
			<li><a href="<?php echo BASE_URL; ?>estoque?p=<?php echo $paginaAtual + 1; ?>"><span style="height: 20px;" class="glyphicon glyphicon-forward" aria-hidden="true"></span></a></li>
		<?php endif; ?>
		<?php if($paginas > 1): ?>

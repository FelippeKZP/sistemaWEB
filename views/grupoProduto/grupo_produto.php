...
<a class="btn btn-info" href="<?php echo BASE_URL; ?>grupoProduto/grupo_produto_add"><span
...
<?php if ($grupo_produto_list == null): ?>
...
<ul class="pagination">
    ...
    <?php endif; ?>
    <?php if ($paginaAtual != 1): ?>
        <li><a href="<?php echo BASE_URL; ?>grupoProduto?p=<?php echo $paginaAtual - 1 ?>"><span
                        class="glyphicon glyphicon-backward" aria-hidden="true" style="height: 20px;"></span></a></li>
    <?php endif; ?>
    <?php for ($q = 1; $q <= $paginas; $q++): ?>
        <?php if ($paginaAtual == $q): ?>
            <li class="active"><a href="<?php echo BASE_URL; ?>grupoProduto?p=<?php echo $q; ?>"><?php echo $q; ?></a>
            </li>
        <?php else: ?>
    ...
    <?php if ($paginaAtual < $paginas): ?>
        <li><a href="<?php echo BASE_URL; ?>cleinte?p=<?php echo $paginaAtual + 1 ?>"><span style="height: 20px;"

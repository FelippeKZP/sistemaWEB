...
<h1>Relatório de Historico de Estoque</h1>
...
<table id="tabela">
    ...
    <?php foreach ($historico_estoque_list as $h): ?>
        <tbody>
            <tr>
                <td><?php echo $h['id']; ?></td>
                <td><?php echo $h['produto']; ?></td>
                <td><?php echo $h['usuario']; ?></td>
                <td><?php echo $h['acao']; ?></td>
                <td><?php echo date('d/m/Y', strtotime($h['data_acao'])); ?></td>
            </tr>
        </tbody>
    <?php endforeach; ?>
</table>

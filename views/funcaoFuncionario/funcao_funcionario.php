...
<a class="btn btn-info" href="<?php echo BASE_URL; ?>funcaoFuncionario/funcao_funcionario_add"><span
...
<ul class="pagination">
    ...
    <?php endif; ?>
    <?php if ($paginaAtual != 1): ?>
        <li><a href="<?php echo BASE_URL; ?>funcaoFuncionario?p=<?php echo $paginaAtual - 1; ?>"><span
                        class="glyphicon glyphicon-backward" aria-hidden="true" style="height: 20px;"></span></a></li>
    <?php endif; ?>
    <?php for ($q = 1; $q <= $paginas; $q++): ?>
        <?php if ($paginaAtual == $q): ?>
            <li class="active"><a
                        href="<?php echo BASE_URL; ?>funcaoFuncionario?p=<?php echo $q; ?>"><?php echo $q; ?></a></li>
        <?php else: ?>
            <li><a href="<?php echo BASE_URL; ?>funcaoFuncionario?p=<?php echo $q; ?>"><?php echo $q; ?></a></li>
        <?php endif; ?>
    <?php endfor; ?>
    <?php for ($q = $paginaAtual + $max; $q <= $paginaAtual + 1; $q++): ?>
        <li class="active"><a href="<?php echo BASE_URL; ?>funcaoFuncionario?p=<?php echo $q; ?>"><?php echo $q; ?></a>
        </li>
    <?php endfor; ?>
    <?php if ($paginaAtual < $paginas): ?>
        <li><a href="<?php echo BASE_URL; ?>funcaoFuncionario?p=<?php echo $paginaAtual + 1; ?>"><span
                        style="height: 20px;" class="glyphicon glyphicon-forward" aria-hidden="true"></span></a></li>
    <?php endif; ?>
    <?php if ($paginas > 1): ?>

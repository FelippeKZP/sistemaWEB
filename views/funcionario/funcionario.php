...
<a class="btn btn-info" href="<?php echo BASE_URL; ?>funcionario/funcionario_add"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Adicionar</a>
        ...
        <?php foreach ($funcionario_list as $f): ?>
            <tbody>
                <tr>
                    ...
                    href="<?php echo BASE_URL; ?>funcionario/funcionario_deletar/<?php echo $f['id']; ?>">

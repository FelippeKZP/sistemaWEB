...
<a class="btn btn-info" href="<?php echo BASE_URL; ?>compra/compra_add"><span class="glyphicon glyphicon-plus"
...
<ul class="pagination">
    ...
    <?php endif; ?>
    <?php if ($paginaAtual != 1): ?>
        <li><a href="<?php echo BASE_URL; ?>compra?p=<?php echo $paginaAtual - 1 ?>"><span
    ...
    <?php if ($paginaAtual < $paginas): ?>
        <li><a href="<?php echo BASE_URL; ?>compra?p=<?php echo $paginaAtual + 1 ?>"><span style="height: 20px;"

...
<form id="form" method="POST">
    ...
    <div class="form-group col-sm-3">
        ...
        <input  type="text" class="form-control" id="data_aniversario" name="data_aniversario" value="<?php echo date('d/m/Y', strtotime($cliente_editar_list['data_aniversario'])); ?>" placeholder="Digite a Data de Aniversário."/>
    </div>

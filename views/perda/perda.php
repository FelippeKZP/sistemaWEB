            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary"
                       href="<?php echo BASE_URL; ?>perda/perda_vizualizar/<?php echo $p['id']; ?>"><span
...
<ul class="pagination">
    ...
    <?php endif; ?>
    <?php if ($paginaAtual != 1): ?>
        <li><a href="<?php echo BASE_URL; ?>perda?p=<?php echo $paginaAtual - 1; ?>"><span
    ...
    <?php if ($paginaAtual < $paginas): ?>
        <li><a href="<?php echo BASE_URL; ?>perda?p=<?php echo $paginaAtual + 1; ?>"><span style="height: 20px;"

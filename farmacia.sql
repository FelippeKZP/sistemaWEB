...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `tipo_pessoa` varchar(20) COLLATE utf8_bin NOT NULL,
  `nome` varchar(80) COLLATE utf8_bin NOT NULL,
  `cpfCnpj` varchar(60) COLLATE utf8_bin NOT NULL,
  `rgIe` varchar(60) COLLATE utf8_bin NOT NULL,
  `telefone` varchar(60) COLLATE utf8_bin NOT NULL,
  `email` varchar(60) COLLATE utf8_bin NOT NULL,
  `data_cadastro` date NOT NULL,
  `data_aniversario` date NOT NULL,
  `cep` varchar(60) COLLATE utf8_bin NOT NULL,
  `bairro` varchar(60) COLLATE utf8_bin NOT NULL,
  `rua` varchar(60) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `compra` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_fornecedor_fk1001` (`id_fornecedor`),
  KEY `id_usuario_fk1002` (`id_usuario`)
...
CREATE TABLE IF NOT EXISTS `contas_pagar` (
  ...
  `id_usuario` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_usuario_fk1785` (`id_usuario`)
...
CREATE TABLE IF NOT EXISTS `contas_receber` (
  ...
  `parcela` varchar(50) COLLATE utf8_bin NOT NULL,
  ...
  `status` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_venda_fk1315` (`id_venda`),
  KEY `id_usuario_fk1320` (`id_usuario`)
...
CREATE TABLE IF NOT EXISTS `fornecedor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `razao_social` varchar(60) COLLATE utf8_bin NOT NULL,
  `nome_fantasia` varchar(60) COLLATE utf8_bin NOT NULL,
  `cnpj` int(60) NOT NULL,
  `ie` int(60) NOT NULL,
  `telefone` varchar(60) COLLATE utf8_bin NOT NULL,
  `data_cadastro` date NOT NULL,
  `cep` varchar(60) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `funcionario` (
  ...
  `rua` varchar(150) COLLATE utf8_bin NOT NULL,
  `numero` varchar(50) COLLATE utf8_bin NOT NULL,
  `carteira` varchar(100) COLLATE utf8_bin NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `id_funcao_fk1457` (`id_funcao`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `grupo_permissao` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_permissao` varchar(80) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `historico_estoque` (
  ...
  `id_usuario` int(11) NOT NULL,
  `acao` varchar(50) COLLATE utf8_bin NOT NULL,
  `data_acao` date NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_produto_fk1007` (`id_produto`),
  KEY `id_usuario_fk1008` (`id_usuario`)
...
CREATE TABLE IF NOT EXISTS `item_compra` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_lote_produto_fk1009` (`id_lote_produto`),
  KEY `id_compra_fk1100` (`id_compra`)
...
CREATE TABLE IF NOT EXISTS `item_perda` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_perda` int(11) NOT NULL,
  `id_lote_produto` int(11) NOT NULL,
  `quantidade` int(11) NOT NULL,
  `total` float NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_lote_produto_fk1120` (`id_lote_produto`),
  KEY `id_perda_fk1110` (`id_perda`)
...
CREATE TABLE IF NOT EXISTS `item_venda` (
  ...
  `total` float NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_venda_fk1130` (`id_venda`),
  KEY `id_lote_produto_fk1140` (`id_lote_produto`)
...
CREATE TABLE IF NOT EXISTS `lote_produto` (
  ...
  `id_fornecedor` int(11) NOT NULL,
  `id_produto` int(11) NOT NULL,
  `numero_lote` varchar(60) COLLATE utf8_bin NOT NULL,
  `data_fabricacao` date NOT NULL,
  `data_vencimento` date NOT NULL,
  `quantidade` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_fornecedor_fk1150` (`id_fornecedor`),
  KEY `id_produto_fk1160` (`id_produto`)
...
CREATE TABLE IF NOT EXISTS `notificacao` (
  ...
  `id_usuarioEnviar` int(11) NOT NULL,
  `data_notificacao` date NOT NULL,
  `tipo_notificacao` varchar(100) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `perda` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_usuario` int(11) NOT NULL,
  `data_perda` int(11) NOT NULL,
  `total_perda` int(11) NOT NULL,
  `motivo` text COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_usuario_fk1170` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `produto` (
  ...
  `cod_barras` varchar(60) COLLATE utf8_bin NOT NULL,
  `quantidade` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `id_grupo_produto_fk1299` (`id_grupo_produto`)
...
CREATE TABLE IF NOT EXISTS `produto_imagem` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_produto_fk1227` (`id_produto`)
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `status` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_grupo_permissao_fk1180` (`id_grupo_permissao`)
...
CREATE TABLE IF NOT EXISTS `usuario_imagem` (
  ...
  `url` varchar(100) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_usuario_fk2221` (`id_usuario`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `venda` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_cliente_fk1190` (`id_cliente`),
  KEY `id_usuario_fk1200` (`id_usuario`),
  KEY `id_funcionario_fk1972` (`id_funcionario`)
...
ALTER TABLE `compra`
  ...
  ADD CONSTRAINT `id_usuario_fk1002` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `contas_receber`
  ...
  ADD CONSTRAINT `id_venda_fk1320` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `historico_estoque`
  ...
  ADD CONSTRAINT `id_usuario_fk1008` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `item_compra`
  ...
  ADD CONSTRAINT `id_lote_produto_fk1009` FOREIGN KEY (`id_lote_produto`) REFERENCES `lote_produto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `item_perda`
  ...
  ADD CONSTRAINT `id_perda_fk1110` FOREIGN KEY (`id_perda`) REFERENCES `perda` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `item_venda`
  ...
  ADD CONSTRAINT `id_venda_fk1130` FOREIGN KEY (`id_venda`) REFERENCES `venda` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `lote_produto`
  ...
  ADD CONSTRAINT `id_produto_fk1160` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `venda`
  ...
  ADD CONSTRAINT `id_funcionario_fk1972` FOREIGN KEY (`id_funcionario`) REFERENCES `funcionario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `id_usuario_fk1200` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

...
class Funcionario extends model
{
    ...
    public function getInfo($id)
    {
        ...
        $sql = $this->db->prepare("SELECT cidade.id_estado, funcionario.* FROM funcionario
        INNER JOIN cidade on cidade.id = funcionario.id_cidade 
    ...
    public function funcionario_add($nome, $cpf, $rg, $telefone, $data_admissao, $data_aniversario, $id_funcao, $carteira_trabalho, $salario, $cep, $bairro, $rua, $numero, $cidade)
    {


        $sql = $this->db->prepare("INSERT INTO funcionario(nome,cpf,rg,telefone,data_admissao,data_aniversario,id_funcao,carteira,salario,cep,bairro,rua,numero,id_cidade)
       VALUES(:nome,:cpf,:rg,:telefone,:data_admissao,:data_aniversario,:id_funcao,:carteira_trabalho,:salario,:cep,:bairro,:rua,:numero,:cidade)");
    ...
    public function funcionario_editar($nome, $cpf, $rg, $telefone, $data_admissao, $data_aniversario, $id_funcao, $carteira_trabalho, $salario, $cep, $bairro, $rua, $numero, $cidade, $id)
    {
       ...
       rua = :rua, numero = :numero,id_cidade = :cidade WHERE id = :id");
        $sql->bindValue(":nome", $nome);
        $sql->bindValue(":cpf", $cpf);
        $sql->bindValue(":rg", $rg);
        $sql->bindValue(":telefone", $telefone);

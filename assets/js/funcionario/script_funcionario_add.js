        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (total == 0) {
                    ...
                    bootbox.alert('O CPF informado já existe no banco de dados.');
                    $('#cpf').val('');
                }
            }
        });
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (total == 0) {
                    ...
                    bootbox.alert('O RG informado já existe no banco de dados.');
                    $('#rg').val('');
                }
            }
        });
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (total == 0) {
                    ...
                    bootbox.alert('A carteira de trabalho já existe no banco de dados.');
                    $('#carteira').val('');
                }
            }
        });
